...
public class DLGPlayLong extends javax.swing.JDialog{
    ...
    public DLGPlayLong (java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

    }
    public DLGPlayLong (java.awt.Frame parent, boolean modal,  ControlaMusica cm) {
        super(parent, modal);
        this.cm = cm;
        initComponents();
        exibeInformacoes();
