...
public class DLGPlayExtends extends javax.swing.JDialog{
    ...
    public DLGPlayExtends(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

    }
    public DLGPlayExtends (java.awt.Frame parent, boolean modal,  ControlaMusica cm) {
        super(parent, modal);
        this.cm = cm;
        initComponents();
        exibeInformacoes();
       ...
       try{
        for(int i=0; i<musica.size(); i++){
            ...
            if(musica.get(i).getLancamento().getDuração()<=600.0 &&cont1<3){      
                compare[k]=musica.get(i).getLancamento().getDuração();    
                    cont1++;
                      k++;
                      if(k==2){
                    i=musica.size();
   ...
   System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
        System.out.println("\n\nEsta eh a sua play list:");
        for(int i=0; i<musica.size(); i++){
            cont=0;
            if(l<3){
                for(int j=0; j<3; j++){ 
                    if(musica.get(i).getLancamento().getDuração()==compare[j]){
                        if(cont==0){
    ...
    private void initComponents() {
        ...
        btnSair.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
